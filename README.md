...
| `COUNTERPICK_ASSET_BASE` | Необязательный HTTPS-префикс CDN для `/assets/`; при bind `0.0.0.0` включается стабильный публичный CDN, а `127.0.0.1` использует локальные файлы. |
